...
You can either download/include ready JS file [here](https://cdn.rawgit.com/plugnburn/monstera/master/output/monstera.js) or install all the necessary dependencies (Git, Node, NPM and `grunt-cli`) and then run:
